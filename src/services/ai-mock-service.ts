// Mock AI Service - Generates travel plans using built-in data
// This is the fallback when no real AI API is configured
...
export async function generateMockTripPlan(input: CreateTripInput): Promise<AIResponse> {
